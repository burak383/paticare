...
export default function OnboardingScreen() {
  ...
  // Required before a NEW account can be created — see handleAuthSubmit and
  // the checkbox row below. Not required for logging into an existing
  // account, which already accepted this at registration time.
  ...
  async function handleAuthSubmit() {
    ...
    try {
      if (authMode === 'register') {
        await register(email.trim(), password, undefined, privacyAccepted);
      } else {
            ...
            <View style={styles.authButtons}>
              ...
              {authMode === 'register' ? (
                <PrivacyConsentCheckbox
                  ...
                  onOpenPolicy={() => setPrivacyModalVisible(true)}
      ...
      <Modal visible={privacyModalVisible} transparent animationType="slide" onRequestClose={() => setPrivacyModalVisible(false)}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Pressable style={styles.modalCancel} onPress={() => setPrivacyModalVisible(false)} testID="privacy-policy-close">
