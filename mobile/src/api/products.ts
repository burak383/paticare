...
// image: captureProductPhoto()'dan gelen data URI — sunucu, backend'de
// GOOGLE_VISION_API_KEY yapılandırılmışsa gerçek görüntü tanımayı dener
// (bkz. backend/src/routes/products.js), yoksa demo eşleşmesine döner.
export async function scanProduct(input: { barcode?: string; name?: string; image?: string; petId?: string }) {
